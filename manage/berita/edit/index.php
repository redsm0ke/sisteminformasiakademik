...
<table class="table">
  ...
  <tbody>
    <tr>
      ...
      <td>:</td>
      <td>
        <input type="text" name="judul" class="form-control" value="<?php echo $tbl_berita['judul']; ?>">
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>:</td>
      <td>
        <textarea name="isi" class="form-control" rows="11"><?php echo $tbl_berita['isi']; ?></textarea>
      </td>
    </tr>
