...
<head>
    ...
    <title>Daftar Pelajaran - <?php echo $tbl_website['nama_sekolah']; ?></title></h3>
</head>
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <h2>Daftar Berita</h2>
              ...
              <div class="alert alert-primary alert-dismissible fade show" role="alert">
                <strong>Berikut adalah daftar berita</strong>
        ...
        ?>
            ...
            if ($_GET['msg'] == "editsukses") {
              echo '
              <div class="alert alert-success alert-dismissible fade show" role="alert">
                <strong>Data anda telah berhasil diubah</strong>
                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                </button>
              </div>';
...
<table id="search" class="table table-striped table-bordered">
  ...
  <tbody>
        ...
        $sql_user     = mysqli_query($db,"SELECT * FROM tbl_berita");
        $no=0;
        while ($data  = mysqli_fetch_array($sql_user)) {
          ...
          <a href="view?id='.$no_urut.'" class="btn btn-sm btn-primary" style="color: #FFF"><i class="fas fa-eye"></i></a>
          ';
            if ($tbl_user['level'] == "Administrator") {
        echo '<a href="edit?id='.$no_urut.'" class="btn btn-sm btn-warning" style="color: #FFF""><i class="fas fa-pencil-alt"></i></a>
          <a href="delete?id='.$no_urut.'" class="btn btn-sm btn-danger" style="color: #FFF"><i class="fas fa-trash-alt"></i></a>
          </td>
          </tr>
