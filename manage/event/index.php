        ...
        <div id="content">
            ...
            <h2>Daftar Event</h2>
              ...
              <div class="alert alert-primary alert-dismissible fade show" role="alert">
                <strong>Berikut adalah daftar event</strong>
...
<table id="search" class="table table-striped table-bordered">
  <thead>
    ...
    <tr>
      ...
      <th scope="col">Tanggal Penulis</th>
  ...
  <tbody>
        ...
        $sql_user     = mysqli_query($db,"SELECT * FROM tbl_event");
        $no=0;
        while ($data  = mysqli_fetch_array($sql_user)) {
            $no_urut          = $data['no_urut'];
            $judul            = $data['judul'];
            $kategori_event   = $data['kategori_event'];
            $isi              = $data['isi'];
