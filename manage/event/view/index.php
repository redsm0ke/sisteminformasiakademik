...
##############################################
    ...
    $sql_berita   = mysqli_query($db,"SELECT * FROM tbl_event WHERE no_urut = '$id'");
    $tbl_event   = mysqli_fetch_array($sql_berita);
...
<head>
    ...
    <title>Lihat Event - <?php echo $tbl_website['nama_sekolah']; ?></title></h3>
</head>
        ...
        <div id="content">
            ...
            <h2>LIHAT EVENT</h2>
              <div class="alert alert-primary alert-dismissible fade show" role="alert">
                Data Event <strong><?php echo $tbl_event['no_urut']; ?></strong>
...
<table class="table">
  ...
  <tbody>
    <tr>
      <td>
            <h2 style="text-align: center;"><?php echo $tbl_event['judul']; ?></h2>
            <center>
            <small>Dibuat oleh: <?php echo $tbl_event['penulis']; ?></small>
            </center>
      </td>
    </tr>
