...
<head>
    ...
    <title>Daftar Pegawai - <?php echo $tbl_website['nama_sekolah']; ?></title></h3>
</head>
        ...
        <div id="content">
            ...
            <h2>Daftar Pegawai</h2>
              ...
              <div class="alert alert-primary alert-dismissible fade show" role="alert">
                <strong>Berikut adalah daftar pegawai</strong>
...
<table id="search" class="table table-striped table-bordered">
  ...
  <tbody>
        <?php
        include '../../assets/includes/db.php';
        $sql_user     = mysqli_query($db,"SELECT DISTINCT nip, nama, tempat_lahir, tanggal_lahir, agama, jenis_kelamin, alamat, no_hp FROM tbl_pegawai order by nip ASC;");
        $no=0;
    ...
    <tr>
      ...
      <td style="text-align: center;">
        <a href="view?id='.$nip.'" class="btn btn-sm btn-primary" style="color: #FFF">
            <i class="fas fa-eye"></i>
        </a>
        <a href="edit?id='.$nip.'" class="btn btn-sm btn-warning" style="color: #FFF"">
            <i class="fas fa-pencil-alt"></i>
        </a>
        <a href="delete?id='.$nip.'" class="btn btn-sm btn-danger" style="color: #FFF">
