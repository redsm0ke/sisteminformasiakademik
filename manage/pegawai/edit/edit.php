...
#######################################
    ...
    if ($tbl_user['level'] == "Administrator") {
      $sql = "UPDATE `tbl_pegawai` SET `nip` = '$nip', `nama` = '$nama', `tempat_lahir` = '$tempat_lahir', `tanggal_lahir` = '$tanggal_lahir', `agama` = '$agama', `jenis_kelamin` = '$jenis_kelamin', `alamat` = '$alamat', `no_hp` = '$no_hp' WHERE `tbl_pegawai`.`nip` = $id";
