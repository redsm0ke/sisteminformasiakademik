...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>:</td>
      <td>
        <input type="text" name="level" class="form-control" value="<?php echo $data_user['level']; ?>">
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>:</td>
      <td>
        <input type="password" name="password" class="form-control" value="<?php echo $data_user['password']; ?>">
      </td>
    </tr>
