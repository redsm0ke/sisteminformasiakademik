...
<head>
    ...
    <title>Daftar Pelanggaran - <?php echo $tbl_website['nama_sekolah']; ?></title></h3>
</head>
        ...
        <div id="content">
            ...
            <h2>Daftar Pelanggaran</h2>
              <div class="alert alert-primary alert-dismissible fade show" role="alert">
                <strong>Berikut adalah daftar pelanggaran</strong>
...
<table id="search" class="table table-striped table-bordered">
  ...
  <tbody>
        ...
        $sql_user   = mysqli_query($db,"SELECT * FROM tbl_pelanggaran");
        $no=0;
        while ($data = mysqli_fetch_array($sql_user)) {
            $no_urut            = $data['no_urut'];  // dr tabel
            $username           = $data['nis'];
            $level              = $data['nama_siswa'];
            $kelas              = $data['kelas'];
