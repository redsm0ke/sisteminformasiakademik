...
<head>
    ...
    <title>Daftar Guru - <?php echo $tbl_website['nama_sekolah']; ?></title></h3>
</head>
        ...
        <div id="content">
            ...
            <h2>Daftar Guru</h2>
              ...
              <div class="alert alert-primary alert-dismissible fade show" role="alert">
                <strong>Berikut adalah daftar guru</strong>
...
<table id="search" class="table table-striped table-bordered">
  ...
  <tbody>
        <?php
        include '../../assets/includes/db.php';
        $sql_user     = mysqli_query($db,"SELECT * FROM tbl_pegawai ORDER BY nip ASC");
        $no=0;
