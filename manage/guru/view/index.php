...
<head>
    ...
    <title>Lihat Guru - <?php echo $tbl_website['nama_sekolah']; ?></title></h3>
</head>
...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>:</td>
      <td>
        <input type="text" name="pelajaran" class="form-control" value="<?php echo $tbl_pegawai['pelajaran']; ?>" disabled>
      </td>
    </tr>
