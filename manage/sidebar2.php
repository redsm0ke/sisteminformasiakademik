            ...
            <ul class="list-unstyled components">
                ...
                <li>
                    ...
                    <ul class="collapse list-unstyled" id="Pelajaran">
                        <li>
                            <a href="../../pelajaran">Daftar Pelajaran</a>
                        </li>
                    </ul>
                </li>
                ...
                echo "       <li>\n";
                echo "           <a href='../../pegawai'>Pegawai</a>\n";
                echo "        </li>\n";
                echo "        <li>\n";
                echo "            <a href='../../guru'>Guru</a>\n";
                echo "        </li>\n";
                echo "    </ul>\n";
                echo "</li>\n\n";
                ...
                echo "        <li>\n";
                echo "            <a href='../../siswa'>Siswa</a>\n";
                echo "        </li>\n";
                echo "        <li>\n";
                echo "            <a href='../../mutasi'>Mutasi</a>\n";
                echo "        </li>\n";
                echo "    </ul>\n";
                echo "</li>\n\n";
                ...
                echo "        <li>\n";
                echo "            <a href='../../pelanggaran'>Riwayat Pelanggaran</a>\n";
                echo "        </li>\n";
                echo "   </ul>\n";
                echo "</li>\n\n";
