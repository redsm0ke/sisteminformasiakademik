        ...
        <div id="content">
            ...
            <h2>Daftar Pelajaran</h2>
              ...
              <div class="alert alert-primary alert-dismissible fade show" role="alert">
                <strong>Berikut adalah daftar pelajaran</strong>
...
<table id="search" class="table table-striped table-bordered">
  <thead>
    ...
    <tr>
      ...
      <th scope="col">Sifat Pelajaran</th>
  ...
  <tbody>
        ...
        $sql_user   = mysqli_query($db,"SELECT * FROM tbl_pelajaran");
        $no=0;
        while ($data = mysqli_fetch_array($sql_user)) {
            ...
            $sifat_pelajaran  = $data['sifat_pelajaran'];
            $no++;
 
            echo '
    <tr>
      <th scope="row"><center>'.$no.'</center></th>
      <td>'.$kode_pelajaran.'</td>
      <td>'.$nama_pelajaran.'</td>
      <td>'.$sifat_pelajaran.'</td>
