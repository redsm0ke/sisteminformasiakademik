...
<head>
    ...
    <title>Tambah Pelajaran - <?php echo $tbl_website['nama_sekolah']; ?></title></h3>
</head>
          ...
          <form method="post" action="add.php">
            ...
            <h2>TAMBAH PELAJARAN</h2>
              <div class="alert alert-primary alert-dismissible fade show" role="alert">
                Silahkan isi data dibawah untuk menambahkan pelajaran
...
<table class="table">
  ...
  <tbody>
    <tr>
      ...
      <td>:</td>
      <td>
        <input type="text" name="kode_pelajaran" class="form-control" value="" placeholder="KODE PELAJARAN" required="">
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>:</td>
      <td>
        <input type="text" name="nama_pelajaran" class="form-control" value="" placeholder="NAMA PELAJARAN" required="">
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>:</td>
      <td>
        <input type="text" name="sifat_pelajaran" class="form-control" value="" placeholder="SIFAT PELAJARAN" required="">
      </td>
    </tr>
